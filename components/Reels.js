...
const reels = [
  ...
  { id: 3, src: "/reel-3.mp4" },
  { id: 4, src: "/reel-4.mp4" },
  { id: 5, src: "/reel-5.mp4" }, // add more reels as needed
];
  ...
  return (
    ...
    >
      ...
      <div className="relative z-10 container mx-auto px-4 text-center">
        ...
        <div
          ref={scrollRef}
          className="flex gap-6 overflow-x-auto scroll-smooth py-4 px-12 snap-x snap-mandatory"
          style={{ paddingLeft: "100px", paddingRight: "100px" }} // extra space for zoom
        >
          {reels.map((reel) => (
            <div
              key={reel.id}
